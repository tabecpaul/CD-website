      ...
      <main className="flex flex-1 flex-col bg-cream">
        ...
        <LegalDocument title="개인정보처리방침" effectiveDate="2026년 8월 9일">
          ...
          <ul>
            ...
            <li>Career Direct 검사 20분 무료 콜백 신청 접수 및 진행 상태 관리</li>
          ...
          <ul>
            ...
            <li>검사 콜백 신청 필수항목: 이름, 이메일, 휴대전화, 희망 날짜·시간대, 상담 주제, 개인정보 수집·이용 동의 여부</li>
            <li>검사 콜백 신청 선택항목: 성별, 연령대, 혼인 여부, 기타 상담 내용, 마케팅 정보 수신 동의 여부, 유입 캠페인 정보</li>
            <li>
