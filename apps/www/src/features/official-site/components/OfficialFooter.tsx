  ...
  return (
    <footer className="bg-navy px-5 py-14 text-cream sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1.1fr_.9fr]">
        <div><CareerDirectLogo variant="white" /><BrandTagline className="mt-5 max-w-lg text-sm font-bold leading-6 text-teal" /><p className="mt-3 max-w-md text-sm leading-7 text-cream/65">자기이해에서 평가·컨설팅·실행계획까지, 고유한 디자인을 발견하고 삶의 방향을 세우도록 돕습니다.</p></div>
